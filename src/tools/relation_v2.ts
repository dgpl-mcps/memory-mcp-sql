...
**Relation Types:** DEPENDS_ON, SUBTASK_OF, FOLLOWS, GOVERNED_BY, PART_OF, WORKS_WITH, KNOWS, TOLD, CONTACTS, BELONGS_TO, MANAGED_BY, OWNS, DEADLINE_FOR, RELATES_TO, BLOCKED_BY, ENABLED_BY, HAS_SUBTASK, HOSTS, RUNS_ON, CAUSED_BY, RESOLVED_BY
